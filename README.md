...
1. [如何排除双细胞](https://github.com/ixxmu/mp_duty/issues/4575) 
2. [单细胞入门必读5篇cns综述](https://github.com/ixxmu/mp_duty/issues/4571) [![文献](https://img.shields.io/github/labels/ixxmu/mp_duty/文献)](https://github.com/ixxmu/mp_duty/labels/文献)
3. [为什么不同癌症的lncRNA表达总数很不一样](https://github.com/ixxmu/mp_duty/issues/4567) 
4. [如果你一定要TCGA数据库的转录组测序的TPM表达量矩阵，不妨自己进行转换啊！](https://github.com/ixxmu/mp_duty/issues/4566) 
5. [如何整合多个单细胞数据集](https://github.com/ixxmu/mp_duty/issues/4561) 
<!-- 1issueTable -->
