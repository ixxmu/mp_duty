...
1. [现代生物学领域的生物信息学权重高吗](https://github.com/ixxmu/mp_duty/issues/3607) 
2. [什么情况下我会把科研思路给你](https://github.com/ixxmu/mp_duty/issues/3593) 
3. [R语言里面如何高效开发R包](https://github.com/ixxmu/mp_duty/issues/3592) 
4. [不应该让单细胞定量成为数据复用的阻碍](https://github.com/ixxmu/mp_duty/issues/3582) 
5. [Python的转录组学分析框架与生态](https://github.com/ixxmu/mp_duty/issues/3575) 
<!-- 1issueTable -->
