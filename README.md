...
1. [上下调基因列表各自独立去做功能注释为什么就不能重叠呢](https://github.com/ixxmu/mp_duty/issues/5551) 
2. [超400病人的临床实验结果还需要生信验证](https://github.com/ixxmu/mp_duty/issues/5534) 
3. [单细胞转录组降维聚类分群过滤基因和过滤细胞的区别](https://github.com/ixxmu/mp_duty/issues/5507) 
4. [让单细胞差异更加明显你需要调整配色方案](https://github.com/ixxmu/mp_duty/issues/5476) 
5. [纯粹靠单细胞转录组数据是很难区分CD4和CD8阳性T细胞](https://github.com/ixxmu/mp_duty/issues/5468) 
<!-- 1issueTable -->
