...
1. [KEGG富集结果7大分类展示](https://github.com/ixxmu/mp_duty/issues/6305) 
2. [做COX生存分析是否需要把连续值变成高低二分组?](https://github.com/ixxmu/mp_duty/issues/6301) 
3. [你没见过的两种高颜值单细胞亚群相关性热图](https://github.com/ixxmu/mp_duty/issues/6297) 
4. [TCGA样本barcode详细介绍](https://github.com/ixxmu/mp_duty/issues/6280) 
5. [复杂相关性散点图复现（ggplot2绘图的层层递进）](https://github.com/ixxmu/mp_duty/issues/6279) 
<!-- 1issueTable -->
